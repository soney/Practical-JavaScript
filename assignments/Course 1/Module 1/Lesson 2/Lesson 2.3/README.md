...
![Expected output: the heading "HTML Basics Course Outline" followed by an ordered list with two lessons and an unordered list under the second lesson](./layout.png)
