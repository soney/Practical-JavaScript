...
// TODO: Define getPasswordFeedback(password, isCorrect) that returns a template-literal message: "<password> is correct. Logging you in..." when isCorrect is true, otherwise "<password> is incorrect. Please try again.".
...
export default {
    ...(typeof getPasswordFeedback !== 'undefined' && { getPasswordFeedback })
};
