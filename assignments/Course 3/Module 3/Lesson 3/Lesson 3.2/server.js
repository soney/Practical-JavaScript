...
app.post("/register", async (req, res) => {
  ...
  // TODO: (1) Never store the plain-text password. Replace the line below
  // with these two lines, which hash the password (10 is the cost factor)
...
app.post("/login", async (req, res) => {
  ...
  // TODO: (2) A hash cannot be compared with ===. Replace the check below
  // with bcrypt.compare, which hashes the submitted password and checks it
