...
// ---------------------------------------------------------------------------
// TODO: Register a listener for the "op" event and update the page for
// each operation. An op list can hold several ops, so loop over them:
//
//   doc.on('op', (ops) => {
//     for (const op of ops) {
//       if (op.p[0] === 'todos') {
...
//   });
//
// op.p is the path: op.p[0] names the list ('todos') and op.p[1] is the
// position in that list. "li" is the inserted item; "ld" is the deleted one.
