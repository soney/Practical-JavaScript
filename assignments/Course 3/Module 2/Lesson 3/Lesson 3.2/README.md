...
The files here are the starter you get in the course. [`solution/client-2.js`](solution/client-2.js) and [`solution/server.js`](solution/server.js) are the finished `client-2.js` and `server.js`; copy them over the starter to run the completed assignment.
