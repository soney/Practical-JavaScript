...
function Preferences() {
  ...
  // TODO: add a React.useEffect (dependency array [darkMode]) that adds the "dark-mode" class to document.body when darkMode is true and removes it when false; return a cleanup that removes the "dark-mode" class
  return (
